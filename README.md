...
See [Deployment & Scaling](./docs/deployment.md) for full setup instructions.

---

## Contributing

We welcome contributions of all kinds — code, translations, Islamic content, and scholar reviews. See the [Contribution Guide](./docs/contributing.md) to get started.

---

## Licence

Source code: [MIT Licence](./docs/licensing.md#1-software-licence)  
Foundation model: [Meta Llama 3 Community Licence](https://llama.meta.com/llama3/license/)

> **Disclaimer:** Muslim AI is an assistive tool, not a replacement for qualified Islamic scholarship. For personal religious decisions, always consult a qualified scholar in your community.